  ...
  <section id="menusection" class="pt-5">
    ...
    <table class="menutable" border="0">
      ...
      <tr>
        <td>S 1.</td>
        <td></td>
        <td>Lobster with Ginger & Scallion
        &nbsp; &nbsp; &nbsp;
        香蔥龍蝦</td>
        <td align="right">S/P</td>
      </tr>
    ...
    <span class="menucategory">War Bar</span>
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
    <span class="zh menucategory">煲類</span>
    ...
    <span class="menucategory">Appetizers</span>
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
    <span class="zh menucategory">頭抬</span>
